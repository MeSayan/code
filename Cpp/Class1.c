 ...
 * of a variable in different parts of code. Whether we can acces a variable
 * or modify (directly and indirectly) depends on the access specifer 
 * associated with the variable
 * In C++ the following access specifiers are provide
 * private : Concerned element (both data and functions) can only be
 * 			 accessed from within the class. This is the default specifer
 * 			 for all elements of a class unless otherwise specified.
